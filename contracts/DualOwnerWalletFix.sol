...
contract DualOwnerWalletFix {
    ...
    function sendFunds(
        ...
        require(
            verifySignatures(signatures, transactionHash),
            "Invalid signature"
        );
    ...
    function calculateTxHash(address recipient, uint amount)
        public
        view
        returns (bytes32)
    {
    ...
    function verifySignatures(bytes[2] memory signatures, bytes32 transactionHash)
        private
        view
        returns (bool)
    {
