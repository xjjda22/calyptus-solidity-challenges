...
describe('VulnerableTokenFix', function () {
    ...
    describe('Transactions', function () {
        it('Should transfer tokens between accounts', async function () {
            ...
            await expect(vToken.transfer(otherAccount.address, 50)).to.changeTokenBalances(vToken, [owner, otherAccount], [-50, 50]);
        });
        ...
        it('Should fail if sender doesn’t have enough tokens', async function () {
            ...
            await expect(vToken.connect(otherAccount).transfer(owner.address, 1)).to.be.revertedWith('ERC20: transfer amount exceeds balance');
    ...
    describe('Auction Bidding', function () {
        ...
        it('Should allow previous highest bidder to withdraw after being outbid', async function () {
            ...
            await expect(vToken.connect(bidder1).withdraw()).to.changeTokenBalances(vToken, [bidder1, vToken], [100, -100]);
        });
